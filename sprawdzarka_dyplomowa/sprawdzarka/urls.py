...
urlpatterns = [
    ...
    path('contests/select/<int:contest_id>/', views.select_contest, name='select_contest'),
    ...
    path('questions/user/', views.question_user_view, name='question_user_view'),
    path('questions/content/<int:question_id>/', views.question_content_view, name='question_content_view'),
    path('questions/teacher/', views.question_teacher_view, name='question_teacher_view'),
    path('questions/contest/<int:contest_id>/', views.question_contest_view, name='question_contest_view'),
    path('questions/answer/<int:question_id>/', views.question_answer_view, name='question_answer_view'),
    path('download/<int:test_id>/<int:in_out>', views.download_file, name='download_file'),
